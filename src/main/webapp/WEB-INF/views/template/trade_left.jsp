		...
		<div class="panel-group category-products" id="accordian">
			...
			<div class="panel panel-default">
				...
				<div id="a" class="panel-collapse collapse" style="height: auto;">
					<div class="panel-body">
						<ul>
							<li><a href="${pageContext.request.contextPath}/trade/list_trade_post.do?boardTypeNo=${requestScope.boardTypeNo}&categoryNo=1">유모차 </a></li>
							<li><a href="${pageContext.request.contextPath}/trade/list_trade_post.do?boardTypeNo=${requestScope.boardTypeNo}&categoryNo=2">카시트 </a></li>
							<li><a href="${pageContext.request.contextPath}/trade/list_trade_post.do?boardTypeNo=${requestScope.boardTypeNo}&categoryNo=3">아기띠 </a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="panel panel-default">
				...
				<div id="b" class="panel-collapse collapse">
					<div class="panel-body">
						<ul>
							<li><a href="${pageContext.request.contextPath}/trade/list_trade_post.do?boardTypeNo=${requestScope.boardTypeNo}&categoryNo=4">유아동 의류</a></li>
							<li><a href="${pageContext.request.contextPath}/trade/list_trade_post.do?boardTypeNo=${requestScope.boardTypeNo}&categoryNo=5">신생아 의류</a></li>
