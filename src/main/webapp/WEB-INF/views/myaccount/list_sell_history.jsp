...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$("#buy").click(function() {
			var url = "${pageContext.request.contextPath}";
			location.href=url+"/myaccount/findTradeHistoryListById.do?&type=구매";
		})
	});
</script>
...
<div class="container">
	<ul class="nav nav-tabs">
		<li class="active"><a href="javascript:;">판매내역</a></li>
		<li><a id="buy" href="#menu1">구매내역</a></li>
	</ul>
					...
					<div class="pagingInfo">
						...
						<ul class="pagination">
							<c:if test="${pb.previousPageGroup}">
								<li><a
									href="findTradeHistoryListById.do?nowPage=${pb.startPageOfPageGroup-1}&type=판매">&laquo;</a></li>
							</c:if>
							<c:forEach var="i" begin="${pb.startPageOfPageGroup}"
								...
								<c:choose>
									<c:when test="${pb.nowPage!=i}">
										<li><a
											href="findTradeHistoryListById.do?nowPage=${i}&type=판매">${i}</a></li>
									</c:when>
									<c:otherwise>
							...
							<c:if test="${pb.nextPageGroup}">
								<li><a
									href="findTradeHistoryListById.do?nowPage=${pb.endPageOfPageGroup+1}&type=판매">&raquo;</a>
								</li>
							</c:if>
						</ul>
					</div>
